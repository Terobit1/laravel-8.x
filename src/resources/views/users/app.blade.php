        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <div class="container-fluid">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('posts.index') }}">Товари</a></li>
            ...
            <form class="form-inline my-2 my-lg-0">
                ...
                <div class="btn-group dropleft">
                    ...
                    <button type="button me-2 " class="btn btn-outline-success my-2 my-sm-0 dropdown-toggle"
                        id="dropdownMenuOffset" data-toggle="dropdown" data-offset="10,20">
                        {{Auth::user()->getName()}}
                    </button>
