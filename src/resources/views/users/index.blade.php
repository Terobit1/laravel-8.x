...
<a style="margin-top: 35px;
          margin-left: 0px;"
   href="{{ route('users.create') }}" class="btn btn-success">Створити користувача</a>
   ...
   @foreach($users as $user)
    <tr>
      ...
      <td class="row" >
        ...
        <div></div>
        <form class=""   method="POST" action="{{ route('users.destroy', $user) }}" data-bs-toggle="modal" data-bs-target="#exampleModal"> 
         @csrf
         @method('DELETE')
