...
@section('title', 'Редактировать пост '.$user->title)
     ...
     @method('PATCH') 
        <div class="form-group">
            ...
            <input type="text" name="name" 
                   value="{{ $user->name }}" class="form-control" id="user-name">
        </div>

        <div class="form-group">
            <label for="users-email">email</label>
            <input type="text" name="email" 
                   value="{{ $user->email }}" class="form-control" id="user-email">
        </div>

        <div class="form-group">
            <label for="user-provider_id">provider_id</label>
            <input type="text" name="provider_id" 
                   value="{{ $user->provider_id }}" class="form-control" id="user-provider_id">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="password" 
                   value="{{ $user->password }}" class="form-control" id="user-password">
        </div>
