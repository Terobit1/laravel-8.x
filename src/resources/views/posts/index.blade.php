...
<a style="margin-top: 35px;
          margin-left: 0px;" href="{{ route('posts.create') }}" class="btn btn-success">Создать пост</a>
        ...
        <tr>
            ...
            <td class="row">
                ...
                <a style="padding-right: 13px;
                  ...
                  margin-top: 6px;
                  margin-right: 3px; 
                  height: 37px;" href="{{ route('posts.edit', $post) }}" class="btn ">
                    <i class="fa fa-pencil"></i>
                </a>
                <div></div>
                <form class="" method="POST" action="{{ route('posts.destroy', $post) }}" data-bs-toggle="modal"
