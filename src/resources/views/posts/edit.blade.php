     ...
     @method('PATCH') 
        ...
        <div class="form-group">
            ...
            <input type="text" name="category_id" 
                   value="{{ $post->category_id }}" class="form-control" id="post-category_id">
        </div>

        <div class="form-group">
            <label for="post-in_stock">В наявності</label>
            <input type="text" name="in_stock" 
                   value="{{ $post->in_stock }}" class="form-control" id="post-in_stock">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="image" 
                   value="{{ $post->image }}" class="form-control" id="post-image">
        </div>
